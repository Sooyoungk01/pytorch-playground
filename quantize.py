...
def main():
    ...
    parser.add_argument('--model_root', default='~/experiment1/models/', help='folder to save the model')
    parser.add_argument('--data_root', default='~/experiment1/data', help='folder to save the model')
